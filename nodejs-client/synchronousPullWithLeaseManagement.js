...
function main(
  projectId = 'gca-st-pubsub-0',
  subscriptionNameOrId = 'subscription-007'
) {
  ...
  async function synchronousPullWithLeaseManagement() {
    ...
    while (waiting) {
      ...
      if (isProcessed) {
        ...
        console.log('Message with ack id ', message.ackId);
        console.log('Waiting 61 seconds before acking message');
        sleep(61000);
        //..acknowledges the message.
        console.log('Acking message now');
        ...
        console.log('Message with ack id ', message.ackId);
        console.log('Waiting 61 seconds before modifying Ack Deadline');
        sleep(61000);
        //..reset its ack deadline.
        console.log('Modacking now');
